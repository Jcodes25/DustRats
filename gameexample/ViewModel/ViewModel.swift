...
class ViewModel: ObservableObject {
    ...
    @Published var roomDialog: storyThing? = storyThing(text: "You went into the drawer thingy and you find 2 things which thing you wanna take you cant take both, this is a videogame", choice:[Choice(description: "column",item: Item(itemImg: "column", itemName: "Column", itemDescription: "beautiful Column")), Choice(description: "column", nextStoryThing: storyThing(text: "This decision makes another story event congrats you did it", choice: [Choice(description: "Whatever")], storyType: .item))], storyType: .item)
